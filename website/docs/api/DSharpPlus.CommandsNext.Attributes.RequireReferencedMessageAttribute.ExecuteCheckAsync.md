...
## <a id="DSharpPlus_CommandsNext_Attributes_RequireReferencedMessageAttribute_ExecuteCheckAsync_DSharpPlus_CommandsNext_CommandContext_System_Boolean_"></a>ExecuteCheckAsync\(CommandContext, bool\)
